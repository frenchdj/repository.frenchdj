...
URL_PLUGIN=                    'plugin://music/MixCloud.mod/'
...
URL_DJFRENCH=                  'http://api.mixcloud.com/djfrench/'
URL_ADAMBEYERPRESENTSDRUMCODE= 'http://api.mixcloud.com/adambeyerpresentsdrumcode/'
URL_FRENCHDJ=                  'http://api.mixcloud.com/frenchdj/'
URL_OLDSCHOOL=                  'http://api.mixcloud.com/oldschool/'
URL_INDIEFRENCH=               'http://api.mixcloud.com/IndieFrench/'
URL_INDIEROCKSUK=              'http://api.mixcloud.com/indierocksuk/'
URL_METALFRENCH=               'http://api.mixcloud.com/MetalFrench/'
URL_STONERWITCHRADIO=          'http://api.mixcloud.com/stonerwitchradio/'
...
MODE_DJFRENCH=                  60
MODE_ADAMBEYERPRESENTSDRUMCODE= 61
MODE_FRENCHDJ=                  62
MODE_OLDSCHOOL=                 63
MODE_INDIEFRENCH=               64
MODE_INDIEROCKSUK=              65
MODE_METALFRENCH=               66
MODE_STONERWITCHRADIO=          67
...
__addon__ =xbmcaddon.Addon('plugin.video.mixcloud.mod')
...
STRLOC_MAINMENU_DJFRENCH=                  __addon__.getLocalizedString(31000)
STRLOC_MAINMENU_ADAMBEYERPRESENTSDRUMCODE= __addon__.getLocalizedString(31001)
STRLOC_MAINMENU_FRENCHDJ=                  __addon__.getLocalizedString(31002)
STRLOC_MAINMENU_OLDSCHOOL=                 __addon__.getLocalizedString(31003)
STRLOC_MAINMENU_INDIEFRENCH=               __addon__.getLocalizedString(31004)
STRLOC_MAINMENU_INDIEROCKSUK=              __addon__.getLocalizedString(31005)
STRLOC_MAINMENU_METALFRENCH=               __addon__.getLocalizedString(31006)
STRLOC_MAINMENU_STONERWITCHRADIO=          __addon__.getLocalizedString(31007)
...
def show_home_menu():
	...
	add_folder_item(name=STRLOC_MAINMENU_DJFRENCH,parameters={STR_MODE:MODE_DJFRENCH},img=get_icon('djfrench.png'))
	add_folder_item(name=STRLOC_MAINMENU_ADAMBEYERPRESENTSDRUMCODE,parameters={STR_MODE:MODE_ADAMBEYERPRESENTSDRUMCODE},img=get_icon('drumcode.png'))
	add_folder_item(name=STRLOC_MAINMENU_FRENCHDJ,parameters={STR_MODE:MODE_FRENCHDJ},img=get_icon('frenchdj.png'))
	add_folder_item(name=STRLOC_MAINMENU_OLDSCHOOL,parameters={STR_MODE:MODE_OLDSCHOOL},img=get_icon('oldschool.png'))
	add_folder_item(name=STRLOC_MAINMENU_INDIEFRENCH,parameters={STR_MODE:MODE_INDIEFRENCH},img=get_icon('indiefrench.png'))
	add_folder_item(name=STRLOC_MAINMENU_INDIEROCKSUK,parameters={STR_MODE:MODE_INDIEROCKSUK},img=get_icon('indierocksuk.png'))	
	add_folder_item(name=STRLOC_MAINMENU_METALFRENCH,parameters={STR_MODE:MODE_METALFRENCH},img=get_icon('metalfrench.png'))
	add_folder_item(name=STRLOC_MAINMENU_STONERWITCHRADIO,parameters={STR_MODE:MODE_STONERWITCHRADIO},img=get_icon('stonerwitchradio.png'))
...
def show_djfrench_menu(offset):
    show_users_menu('/djfrench/',0)

def show_adambeyerpresentsdrumcode_menu(offset):
    show_users_menu('/adambeyerpresentsdrumcode/',0)
	
def show_frenchdj_menu(offset):
    show_users_menu('/frenchdj/',0)
	
def show_oldschool_menu(offset):
    show_users_menu('/oldschool/',0)

def show_indiefrench_menu(offset):
    show_users_menu('/indiefrench/',0)

def show_indierocksuk_menu(offset):
    show_users_menu('/indierocksuk/',0)

def show_metalfrench_menu(offset):
    show_users_menu('/metalfrench/',0)

def show_stonerwitchradio_menu(offset):
    show_users_menu('/stonerwitchradio/',0)
...
elif mode==MODE_DJFRENCH:
    ok=show_djfrench_menu(offset)
elif mode==MODE_ADAMBEYERPRESENTSDRUMCODE:
    ok=show_adambeyerpresentsdrumcode_menu(offset)
elif mode==MODE_FRENCHDJ:
    ok=show_frenchdj_menu(offset)
elif mode==MODE_OLDSCHOOL:
    ok=show_oldschool_menu(offset)
elif mode==MODE_INDIEFRENCH:
    ok=show_indiefrench_menu(offset)
elif mode==MODE_INDIEROCKSUK:
    ok=show_indierocksuk_menu(offset)
elif mode==MODE_METALFRENCH:
    ok=show_metalfrench_menu(offset)
elif mode==MODE_STONERWITCHRADIO:
    ok=show_stonerwitchradio_menu(offset)
